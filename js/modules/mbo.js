...
function renderWPYearGrid(year){
  ...
  var contentStyle = _yearGridExpanded ? 'transition:max-height .35s ease,opacity .25s ease;overflow:hidden' : 'transition:max-height .35s ease,opacity .25s ease;overflow:hidden;max-height:0;opacity:0';
...
function renderWPTable(plan){
  ...
  html+='<div class="wp-table-area"><div class="wp-table-wrap"><table class="wp-table"><colgroup><col style="width:56px"><col style="width:180px"><col style="width:80px"><col style="width:115px"><col style="width:115px"><col style="width:115px"><col style="width:56px"><col style="width:90px"><col style="width:48px"><col style="width:80px"><col style="width:150px"><col style="width:90px"><col style="width:56px"><col style="width:200px"><col></colgroup><thead><tr>';
  ...
  if(plan.aiAnalysis && plan.aiAnalysis.trim()){
    html+='<div class="wp-feedback-textarea" id="aiAnalysisContent" style="background:#F4F0FF;border:1px solid #d4c8f0;font-size:13px;line-height:1.8;white-space:pre-wrap;transition:max-height .35s ease,opacity .25s ease,padding .25s ease;overflow:hidden;max-height:0;opacity:0;padding:0;margin-top:0">'+_h(plan.aiAnalysis)+'</div>';
  }else{
    html+='<div class="wp-feedback-empty" id="aiAnalysisContent" style="background:#F4F0FF;border:1px dashed #d4c8f0;transition:max-height .35s ease,opacity .25s ease,padding .25s ease;max-height:0;opacity:0;padding:0">点击上方「AI-分析建议」按钮，生成本周整体分析报告</div>';
  }
  html+='</div>';
...
function _renderEisenhowerMatrix(year){
  ...
  var contentStyle=_matrixExpanded?'transition:max-height .4s ease,opacity .3s ease;overflow:hidden':'transition:max-height .4s ease,opacity .3s ease;overflow:hidden;max-height:0;opacity:0';
...
function _renderAnnualProgress(year){
  ...
  var contentStyle = _progressExpanded ? 'transition:max-height .35s ease,opacity .25s ease;overflow:hidden' : 'transition:max-height .35s ease,opacity .25s ease;overflow:hidden;max-height:0;opacity:0';
...
function _renderTimeManagementPanel(plan){
  ...
  var _cs=function(id){return _wpCardExpanded[id]?'transition:max-height .35s ease,opacity .25s ease;overflow:hidden':'transition:max-height .35s ease,opacity .25s ease;overflow:hidden;max-height:0;opacity:0';};
