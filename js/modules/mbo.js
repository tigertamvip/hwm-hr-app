...
function renderWPYearGrid(year){
  ...
  var contentStyle = _yearGridExpanded ? 'transition:max-height .5s cubic-bezier(.4,0,.2,1),opacity .35s cubic-bezier(.4,0,.2,1);overflow:hidden' : 'transition:max-height .45s cubic-bezier(.4,0,.2,1),opacity .2s cubic-bezier(.4,0,.2,1);overflow:hidden;max-height:0;opacity:0';
...
function renderWPTable(plan){
  ...
  if(plan.aiAnalysis && plan.aiAnalysis.trim()){
    html+='<div class="wp-feedback-textarea" id="aiAnalysisContent" style="background:#F4F0FF;border:1px solid #d4c8f0;font-size:13px;line-height:1.8;white-space:pre-wrap;transition:max-height .5s cubic-bezier(.4,0,.2,1),opacity .35s cubic-bezier(.4,0,.2,1),padding .25s cubic-bezier(.4,0,.2,1);overflow:hidden;max-height:0;opacity:0;padding:0;margin-top:0">'+_h(plan.aiAnalysis)+'</div>';
  }else{
    html+='<div class="wp-feedback-empty" id="aiAnalysisContent" style="background:#F4F0FF;border:1px dashed #d4c8f0;transition:max-height .5s cubic-bezier(.4,0,.2,1),opacity .35s cubic-bezier(.4,0,.2,1),padding .25s cubic-bezier(.4,0,.2,1);max-height:0;opacity:0;padding:0">点击上方「AI-分析建议」按钮，生成本周整体分析报告</div>';
  }
  html+='</div>';
...
function _renderEisenhowerMatrix(year){
  ...
  var contentStyle=_matrixExpanded?'transition:max-height .5s cubic-bezier(.4,0,.2,1),opacity .35s cubic-bezier(.4,0,.2,1);overflow:hidden':'transition:max-height .45s cubic-bezier(.4,0,.2,1),opacity .2s cubic-bezier(.4,0,.2,1);overflow:hidden;max-height:0;opacity:0';
...
function _renderAnnualProgress(year){
  ...
  var contentStyle = _progressExpanded ? 'transition:max-height .5s cubic-bezier(.4,0,.2,1),opacity .35s cubic-bezier(.4,0,.2,1);overflow:hidden' : 'transition:max-height .45s cubic-bezier(.4,0,.2,1),opacity .2s cubic-bezier(.4,0,.2,1);overflow:hidden;max-height:0;opacity:0';
...
function _renderTimeManagementPanel(plan){
  ...
  var _cs=function(id){return _wpCardExpanded[id]?'transition:max-height .5s cubic-bezier(.4,0,.2,1),opacity .35s cubic-bezier(.4,0,.2,1);overflow:hidden':'transition:max-height .45s cubic-bezier(.4,0,.2,1),opacity .2s cubic-bezier(.4,0,.2,1);overflow:hidden;max-height:0;opacity:0';};
